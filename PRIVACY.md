...
The extension may use Chrome's local/sync storage only to remember the user's selected terminal preference.
...
Commands are executed by the user's own operating-system account through the local terminal. Users should only run commands they understand and trust.

## Contact

For privacy questions or security reports, please use the GitHub repository's Issues page or the contact details published by Digital Generationz.

## Changes

This policy may be updated as the product develops. The current version is published in this repository.
